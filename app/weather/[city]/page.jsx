...
import "../../../src/styles/WeatherDetails.css"; // Adjusted path for app/weather/[city]/page.jsx

const WeatherDetails = () => {
  const params = useParams(); // Next.js useParams
  const city = params.city ? decodeURIComponent(params.city) : null; // Decode param
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (!stored) {
        router.push("/login"); // navigate -> router
        return;
      }
