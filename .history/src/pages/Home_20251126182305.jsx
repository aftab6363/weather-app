...
const Home = () => {
  ...
  // Scroll animations
  useEffect(() => {
    const elements = document.querySelectorAll(".fade-in-up, .slide-in-left, .slide-in-right, .scale-in, .fade-in, .fade-in-right");
            ...
            <div className="hero-left">
              ...
              <div className="search-container fade-in-delay2">
                ...
                <div className="quick-cities">
                  <span className="quick-chip" onClick={() => { setCity("New York"); fetchWeather("New York"); }}>🗽 New York</span>
                  <span className="quick-chip" onClick={() => { setCity("Tokyo"); fetchWeather("Tokyo"); }}>🗼 Tokyo</span>
                  <span className="quick-chip" onClick={() => { setCity("Paris"); fetchWeather("Paris"); }}>🗼 Paris</span>
                </div>
                    ...
                    <div className="weather-card glass fade-in">
                      <div className="weather-main">
                        <div className="weather-left">
                          {weatherData.icon && (
                            <img src={weatherData.icon} alt="weather icon" className="weather-icon floating" />
                          )}
                        </div>
                      ...
                      <div className="weather-actions">
                        ...
                        <button className="save-btn" onClick={handleSaveCity}>Save</button>
                      </div>
                    </div>
                  )}
                </div>
