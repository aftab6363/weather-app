            ...
            <div className="hero-left">
              ...
              <div className="search-container fade-in-delay2">
                ...
                <div className="quick-cities">
                  <span className="quick-chip" onClick={() => setCity("New York")}>🗽 New York</span>
                  <span className="quick-chip" onClick={() => setCity("Tokyo")}>🗼 Tokyo</span>
                  <span className="quick-chip" onClick={() => setCity("Paris")}>🗼 Paris</span>
                </div>
              </div>
