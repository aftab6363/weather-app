        ...
        <div className="safety-container">
          ...
          <div className="safety-header">
            ...
            <h2 className="safety-title">
              Stay Prepared With <span className="gradient-text">Smart Weather Tips</span>
            </h2>

            <p className="safety-desc">
              Helpful precautions and quick guidance to stay safe during extreme weather conditions.
            </p>
          </div>
          ...
          <div className="safety-cards">
            ...
            <div className="safety-card glass">
              ...
              <p>
                Drink plenty of water, avoid outdoor activities, and stay in shaded or air-conditioned areas.
              </p>
            </div>
            ...
            <div className="safety-card glass">
              ...
              <p>
                Keep emergency supplies ready, avoid flooded roads, and follow local weather alerts.
              </p>
            </div>
            ...
            <div className="safety-card glass">
              ...
              <p>
                Wear layered clothing, protect extremities, and limit outdoor exposure during severe cold.
              </p>
            </div>
