...
const WeatherDetails = () => {
  ...
  // 🚨 STRICT LOGIN PROTECTION — fires BEFORE API call
  useEffect(() => {
    try {
      ...
      if (!isLoggedIn) {
        return navigate("/login"); // BLOCK access immediately
      }
    } catch {
  ...
  // Fetch weather after login check passes
  useEffect(() => {
