...
const WeatherDetails = () => {
  ...
  // ✅ Robust login check on page load
  useEffect(() => {
    try {
      ...
      // If localStorage JSON is malformed
      navigate("/login");
    }
  }, [navigate]);

  // ⭐ Safety fallback if city param is missing
  useEffect(() => {
    if (!city) {
      navigate("/dashboard");
    }
  ...
  const saveCity = async () => {
    ...
    try {
      ...
      console.log("Saving city:", city, "for user:", userId);
  ...
  // Fetch forecast whenever city param changes
  useEffect(() => {
