...
const Home = () => {
  ...
  const handleSearch = () => {
    if (city.trim() !== "") {
      alert(`Searching weather for: ${city}`); // Replace with actual API call
      setCity("");
    }
  };
        ...
        <div className="hero-overlay">
          <div className="hero-content">
            <div className="hero-left">
              ...
              {/* ===== MODERN WEATHER SEARCH BAR ===== */}
              <div className="search-bar fade-in-delay3">
                <input
                  type="text"
      ...
      <section className="cities-weather fade-in-up">
        ...
        <div className="cities-grid">
          <div className="city-card">
            <img src={islamabad} alt="Islamabad" className="city-img" />
          ...
          <div className="city-card">
            <img src={london} alt="London" className="city-img" />
            <div className="city-info">
              <h3>London</h3>
          ...
          <div className="city-card">
            <img src={beijing} alt="Beijing" className="city-img" />
            <div className="city-info">
              <h3>Beijing</h3>
          ...
          <div className="city-card">
            <img src={dubai} alt="Dubai" className="city-img" />
            <div className="city-info">
              <h3>Dubai</h3>
