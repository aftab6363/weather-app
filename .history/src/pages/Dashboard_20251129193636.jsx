...
export default function Dashboard() {
  ...
  // Fetch all saved cities for the user
  const fetchSavedCities = async () => {
    ...
    try {
      const res = await fetch(`http://localhost:5000/api/favorite-cities/user/${userId}`);
  ...
  const fetchWeatherForCities = async (cities) => {
    const apiKey = "3e40040b5295e90a19ae7ea070b7a7df"; // Your API key
